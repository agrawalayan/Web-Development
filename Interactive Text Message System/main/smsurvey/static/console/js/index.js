...
function enrolment_plugin() {
	$("#page-wrapper-manage-plugins").hide();
	$("#page-wrapper-plugin").hide();
	$("#page-wrapper-add-plugin").hide();
	$("#page-wrapper-home").show();
	$("#a_home").html("<i class=\"fa fa-desktop fa-fw \"></i> Console -> <i class=\"fa fa-cubes fa-fw \"></i> Enrolment Plugin");
	document.getElementById("page-wrapper-home").innerHTML='<object width="1000" height="1000" type="text/html" data="https://s3.amazonaws.com/rapid-sms/EnrollmentPlugin/enrollment_plugin/templates/enrollments/config.html" ></object>';
...
function sms_plugin() {
	...
	$("#page-wrapper-add-plugin").hide();
	$("#page-wrapper-home").show();
	$("#a_home").html("<i class=\"fa fa-desktop fa-fw \"></i> Console -> <i class=\"fa fa-cubes fa-fw \"></i> RapidSMS Plugin");
	document.getElementById("page-wrapper-home").innerHTML='<object width="1000" height="1000" type="text/html" data="https://s3.amazonaws.com/rapid-sms/RapidSMSPlugin/rapidsms_plugin/templates/rapidsms/config.html" ></object>';
}
function scheduler_plugin() {
	$("#page-wrapper-manage-plugins").hide();
	$("#page-wrapper-plugin").hide();
	$("#page-wrapper-add-plugin").hide();
	$("#page-wrapper-home").show();
	$("#a_home").html("<i class=\"fa fa-desktop fa-fw \"></i> Console -> <i class=\"fa fa-cubes fa-fw \"></i> Scheduler Plugin");
	document.getElementById("page-wrapper-home").innerHTML='<object width="1000" height="1000" type="text/html" data="https://s3.amazonaws.com/rapid-sms/SchedulerPlugin/schedule_plugin/templates/schedule/config.html" ></object>';
}
